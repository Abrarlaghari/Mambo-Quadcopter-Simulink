...
#ifndef RTW_HEADER_Flight_types_h_
#define RTW_HEADER_Flight_types_h_
#include "rtwtypes.h"
...
typedef struct P_Geofencingerror_Flight_T_ P_Geofencingerror_Flight_T;

/* Parameters for system: '<Root>/Flight Control System' */
typedef struct P_FlightControlSystem_Flight_T_ P_FlightControlSystem_Flight_T;

/* Parameters (default storage) */
typedef struct P_Flight_T_ P_Flight_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Flight_T RT_MODEL_Flight_T;

#endif                                 /* RTW_HEADER_Flight_types_h_ */
